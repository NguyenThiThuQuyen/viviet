...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        <a class="navbar-brand" href="/homepage">VIVIET</a>
    ...
    <div class="text-center mx-auto">
        <div class="mt-5">
            <button type="button" class="btn btn-outline-dark btn-lg btn-light">
                <a href=" " class="text-dark" style="text-decoration: none;">Best Seller</a>
            </button>
            <button type="button" class="btn btn-outline-dark btn-lg btn-light">
                <a href=" " class="text-dark" style="text-decoration: none;">Món Mới</a>
            </button>
            <button type="button" class="btn btn-outline-dark btn-lg btn-light">
                <a href=" " class="text-dark" style="text-decoration: none;">Món Chính</a>
            </button>
        </div>
        <div class="mt-4">
            <button type="button" class="btn btn-outline-dark btn-lg btn-light">
                <a href=" " class="text-dark" style="text-decoration: none;">Khai Vị</a>
            </button>
            <button type="button" class="btn btn-outline-dark btn-lg btn-light">
                <a href=" " class="text-dark" style="text-decoration: none;">Tráng Miệng</a>
            </button>
            <button type="button" class="btn btn-outline-dark btn-lg btn-light">
                <a href=" " class="text-dark" style="text-decoration: none;">Đồ Uống</a>
            </button>
            <button type="button" class="btn btn-outline-dark btn-lg btn-light">
                <a href=" " class="text-dark" style="text-decoration: none;">Rượu</a>
            </button>
        </div>
